...
const tourSchema = new mongoose.Schema({
    ...
    difficulty: {
        ...
        enum: {
            ...
            message: 'Difficulty options are: easy, medium or difficult' 
        }
    },
    ratingsAverage: {
        type: Number,
    ...
    priceDiscount: {
        ...
        validate: {
            ...
            message: 'Discount price must be less than regular price which is ({VALUE})'
        }
    },
    summary: {
        type: String,
...
// // Post middleware run after data has been saved
