...
var signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(email, password, passwordConfirm) {
    var res;
...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // Extend map bound to include new marker
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_rOtL3Qw34rceo6qF2ILuB7SI00O44opkKK'); // Get check out session from API
          ...
          case 4:
            ...
            console.log(session); // Create check out form + charge the credit card
...
if (signupForm) {
  document.querySelector('.form').addEventListener('submit', function (e) {
    ...
    (0, _login.signup)(email, password, passwordConfirm);
  });
}
